Namespace Code.MovimentoContabil
    Public Class MovimentoContabilSQL
        ...
        Public Function SelectMovimentoContabil() As String
            ...
            stringBuilder.Append(" from MRT.MOVIDTCTBCLO a ")
            stringBuilder.Append(" inner join MRT.T0123590  b on b.NOMSISINF = a.NOMSISINF And  b.CODEVTCTB = a.CODEVTCTB  ")
            stringBuilder.Append(" inner Join MRT.T0108435  c on 		  c.CODFTOCTB = a.CODFTOCTB where a.CODUNDNGC = :codUndNgc")
            stringBuilder.Append(" Order By a.CODCNTCTB, a.NOMSISINF, a.CODEVTCTB, a.CODFTOCTB ")
            Return stringBuilder.ToString()
        End Function
        ...
        Public Function SelectDatasMovimentoContabilPorCarga() As String
            Dim stringBuilder As New StringBuilder()
            stringBuilder.Append(" Select distinct(DATEFTLMTCTB) from MRT.MOVCTBCLOSISCOB where NUMSEQCRGTAB = :numSeqCarga")
            Return stringBuilder.ToString()
        End Function
    End Class
End Namespace
